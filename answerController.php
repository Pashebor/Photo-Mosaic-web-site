...
echo("
    ...
    <table style='margin: auto; width: 800px' align='center'>
     <tr>
...
echo("
  <h2 align = 'center'>Заказы</h2>
   <table style='margin: auto; width: 800px'>
     <tr>
        <th>Номер записи</th><th>Стиль</th><th>Формат</th><th>Заказчик</th><th>Почта</th><th>Телефон</th><th>Город</th><th>Вид доставки</th><th>Пожелания</th><th>Статус сообщения</th>
    </tr>");
...
while ($dataOrders = mysql_fetch_array($queryOrders)){
    ...
    echo("
      <tr>
          <td>$dataOrders[id]</td><td>$dataOrders[style]</td><td>$dataOrders[format]</td><td>$dataOrders[fio]</td><td style='width: 300px'>$dataOrders[email]</td><td>$dataOrders[phone]</td><td>$dataOrders[city]</td><td>$dataOrders[delivery]</td><td>$dataOrders[wishes]</td><td>$checkerOrders</td>
      </tr>
      ");
}
echo("</table>
