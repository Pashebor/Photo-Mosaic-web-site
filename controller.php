...
if(isset($btnAnswer)){
    ...
    $mailer->addAddress($_POST['email'], 'Milena Studio');
    $mailer->isHtml(true);
    $mailer->Subject = 'Отклик на отзыв';
    $mailer->Body = '<p>Ваш отзыв опубликован на сайте!</p><a href="http://pashebor.rurs.net/mozaika/reviews/"><b>ССЫЛКА</b></a>';
...
if(isset($approve)){
    ...
    $mailer->From = 'milena.studio@mail.ru';
    $mailer->FromName = 'Milena Studio';
    $mailer->addAddress($_POST['emailOrder'], 'Milena Studio');
    $mailer->isHtml(true);
